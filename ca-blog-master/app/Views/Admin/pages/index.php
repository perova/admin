    ...
    <div class="row text-center">
        <div class="col margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="/' . CONFIG['site_path'] . '/admin/pages"> CREATE</a>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            foreach ($data['paginate'] as $page) {
                echo '
        <tr> <td>' . $page['id'] . '</td> <td>' . $page['title'] . '</td><td>' . $page['body'] . '</td><td>' . $page['slug'] . '</td><td>' .  '</td>
        <td>
        <a class="btn btn-primary" href="/' . CONFIG['site_path'] . '/admin/pages"> Edit</a>
          <a class="btn btn-danger" href="/' . CONFIG['site_path'] . '/admin/pages"> Delete</a>
        </td> </tr>
...
for ($i = 0; $i <= ceil(sizeof($data['pages']) / $postsPerPage) - 1; $i++) {
    echo '
        
        <a class="btn btn-outline-primary" href="' . "/" . CONFIG['site_path'] . "/Admin/pages?page=" . ($i + 1) . '">' . ($i + 1) . '</a>
